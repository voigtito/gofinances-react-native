...
import { Container, Header, Photo, UserInfo, User, UserGreatings, UserName, UserContainer, Icon, HighlightCards, Transactions, Title, TransactionList, LogoutButton } from './styles';
